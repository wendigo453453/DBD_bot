...
url = "https://www.leaksbydaylight.com/category/leaks/"
...
for i in data:
    ...
    with open("leaks_dict.json", "w", encoding='windows-1251') as file:
        json.dump(leaks_dict, file, indent=4, ensure_ascii=False)